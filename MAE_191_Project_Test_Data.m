...
%% PET Dogbone Test 1
data = readtable('PET Dogbone Test 1.csv');
...
title('Stress-Strain Curve of PET Dogbone (Test 1)')
...
%% PET Dogbone Test 2
data2 = readtable('PET Dogbone Test 2.csv');
...
ylabel('Engineering Stress (MPa)')
title('Stress-Strain Curve of PET Dogbone (Test 2)')
legend('Stress-Strain', '0.2% Offset Line', ...
...
exportgraphics(gcf, fullfile(imagesFolder, 'PET_Stress_Strain.png'), 'Resolution', 300);
%% PLA Dogbone Test 1
data3 = readtable('PLA Dogbone Test 1.csv');
...
ylabel('Engineering Stress (MPa)')
title('Stress-Strain Curve of PLA Dogbone (Test 1)')
legend('Stress-Strain', '0.2% Offset Line', ...
...
%% PLA Dogbone Test 2
data4 = readtable('PLA Dogbone Test 2.csv');
...
xlabel('Engineering Strain (mm/mm)')
ylabel('Engineering Stress (MPa)')
title('Stress-Strain Curve of PLA Dogbone (Test 2)')
legend('Stress-Strain', '0.2% Offset Line', ...
...
exportgraphics(gcf, fullfile(imagesFolder, 'PLA_Stress_Strain.png'), 'Resolution', 300);
